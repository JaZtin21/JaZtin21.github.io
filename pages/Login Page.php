...
<body style="background-color:white;background-size:cover;background-attachment:fixed;">
	...
	<nav class="navbar-expand-md sticky-top py-1"
		style="background-color:#A31F1F;box-shadow: 0px 0 18px rgba(55, 66, 59, 0.08);box-shadow:   0px 0.1px 5px 0px white; z-index:1000;">
		<div class="container" style="max-width:1150px;">
			<div class="d-flex">

				<div class="d-inline-flex align-items-center " style="">
					<button onclick="Opensidenav()"
						class=" ml-2 mr-1 ml-md-0 d-sm-block d-md-none my-0 align-items-center d-flex " type="button"
						style="background-color:white;font-size:25px;border:1px solid #F2FCFF;border-radius:3px;">
						<span class="fas fa-bars my-1 opensidenav "
							style="background-color:white;color:black;line-height:1.1!important"></span>
					</button>
						...
						<ul class="navbar-nav ">
							<li class="nav-item ">
								<a class="nav-link" style="color:white;text-decoration:none;"
									href="CETproj.html">Welcome Visitor!</a>
							</li>
				...
				<div class="collapse navbar-collapse ml-1   " id="collapsibleNavbar">
					<div class=" d-flex ml-auto " style="">
						...
						<ul class="navbar-nav ">
							...
							<li class="nav-item">
								<a class="nav-link navlinkbuttons" href="#" data-toggle="modal"
									data-target="#myModal">Contact Us</a>
							</li>
						</ul>
	...
	<div class="container mt-0 px-lg-3  px-md-2 px-1 navchange h-25 " style="max-width:1150px;">
		...
		<div class="d-inline-flex w-100">
			...
			<div class="rightblock ml-0 ml-lg-3 pb-4 d-flex align-items-center justify-content-center"
				style="flex-direction:column;min-height:700px;">

				<div class="loginpagecontainer browsecontainer d-flex w-100 align-items-center justify-content-center h-100  mt-3"
					style="min-height:498px;">

					<div class="bg-light loginforms  py-2  d-block align-items-center "
						...
						<form class="d-none" action="confirmation.php" method="post" autocomplete="false"
							autocomplete="off">
							<div class="modal-header align-items-center">
								<h4 class="modal-title">Login as Admin</h4>
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"
									style="color: #F8ECFF;opacity:1;outline:none;">&times;</button>
							</div>
							...
							<div class="modal-footer justify-content-center">
								...
								<input type="submit" class="btn btn-light" value="Sign Up"
									style="background-color:#F48BA9 !important;color:white;width:50%;box-shadow:0px 1px 1px 0px black;">
							</div>
						</form>
					</div>
