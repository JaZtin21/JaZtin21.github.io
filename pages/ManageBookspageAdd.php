		...
		<div class="d-inline-flex w-100">
			...
			<div class="rightblock ml-0 ml-lg-3 pb-4 d-flex align-items-center justify-content-center" style="flex-direction:column;">
				...
				<div class="pt-3 sticktodapat d-none d-lg-block" style="box-shadow:none;border-bottom:2px solid #b3b5b7;">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item advtabs">
							<a href="ManageBookspageAdd.html" class="nav-link active pt-3" data-toggle="tab" href="#home">
						...
						<li class="nav-item advtabs">
							<a href="ManageBookspageEdit.html" class="nav-link  pt-3">
							...
							<div class="d-flex addbookform justify-content-center px-0 mx-0 mt-3">
								<form class="" action="../scripts/addBook.php" method="post" autocomplete="false" autocomplete="off" enctype="multipart/form-data">
									<div class="modal-header bookimageinput align-items-center justify-content-center py-2  d-flex ">
										...
										<div class="mt-2">
											<input type='file' name="image_file" class="fileinput" required onchange="readURL(this);">
										</div>
									</div>
									<div class="modal-body  ">
										<div class="form-group">
											<label>Title:</label>
											<input type="text" name="book_title" class="form-control" required autocomplete="off" autocomplete="false">
										</div>
										<div class="form-group">
											<label>Author:</label>
											<input type="text" name="book_author" class="form-control" required autocomplete="off" autocomplete="false">
										</div>
										<div class="form-group">
											<label>ISBN:</label>
											<input type="text" name="book_isbn" class="form-control" required autocomplete="off" autocomplete="false">
										</div>


										<div class="form-group">
											<label>Publisher:</label>
											<input type="text" name="book_publisher" class="form-control" required autocomplete="off" autocomplete="false">
										</div>
										<div class="form-group">
											<label>Description:</label>
											<textarea rows="5" input name="book_description" type="text" class="form-control" required autocomplete="off" autocomplete="false"></textarea>
										</div>
									</div>
				...
				<div class="modal-body">				
					<div class="form-group">
						<label>Title:</label>
						<input type="text" class="form-control" required autocomplete="off"  autocomplete="false" >
					</div>
					<div class="form-group">
						<label>Author:</label>
						<input type="text" class="form-control" required autocomplete="off"  autocomplete="false" >
